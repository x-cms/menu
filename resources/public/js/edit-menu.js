...
let ManageMenu = function () {
    ...
    let handleItems = function () {
        ...
        let renderListItem = function (data) {
            ...
            let itemTypeText = Helpers.arrayGet(data, 'typeText', '');
            ...
            listItem = listItem.replace(/__type__/gi, itemTypeText);
            let $listItem = $(listItem);

            $listItem.find('[data-field=title] input[type=text]').val(title);
