...
<link rel="stylesheet" href="{{ asset('vendor/core/css/menu-nestable.css') }}">
@endpush
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="box-group" id="accordion">
                <div class="box box-primary box-link-menus" data-type="page" data-type-text="页面">
                    ...
                    <div class="box-footer">
                        <div class="text-right">
                            <button class="btn btn-primary add-item" type="submit">
                                <i class="fa fa-plus"></i> 添加到菜单
                            </button>
                        </div>
                    </div>
                </div>
                <div class="box box-primary box-link-menus" data-type="category" data-type-text="分类">
                    <div class="box-header with-border">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        @include('menu::partials.checkbox', ['collection' => $categories])
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer">
                        <div class="text-right">
                ...
                <div class="box box-primary box-link-menus" data-type="tag"  data-type-text="标签">
                    <div class="box-header with-border">
                ...
                <div class="box box-primary box-link-menus" data-type="custom-link" data-type-text="自定义链接">
                    <div class="box-header with-border">
        ...
        <div class="col-md-9">
            <form class="form-horizontal form-bordered" method="post" action="{{ route('menus.update', ['id' => $menu->id]) }}">
                {{ csrf_field() }}
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group last">
                            <label class="col-md-2 control-label">菜单结构</label>
                            <div class="col-md-6">
...
<script src="{{ asset('vendor/core/js/edit-menu.js') }}"></script>
@endpush
