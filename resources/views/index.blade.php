...
@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <div class="pull-left">
                <a class="btn btn-block btn-success" href="{{ route('menus.create') }}">
...
<script>
    let dtGridColumns = [
        {id: 'name', title: '菜单名称', fastQuery: true},
        {id: 'slug', title: '别名'},
        {id: 'order', title: '排序'},
        {
            id: 'operation', title: '管理操作', resolution: function (value, record, column, grid, dataNo, columnNo) {
            return "<a href='menus/edit/" + record.id + "' class='btn btn-sm btn-warning m-r-5'><i class='fa fa-edit'></i>&nbsp;编辑&nbsp;</a>" +
